...
class Utils
{
    ...
    public static function get_shortcode_name() {
        ...
        return mb_strtolower( apply_filters("get_{DOMAIN}_shortcode_name", 'modal') );
    }

    public static function get_posttype_name() {

        return mb_strtolower( apply_filters("get_{DOMAIN}_posttype_name", 'modal') );
    }
